...
<html lang="en">
    ...
    <div id="nav1">
        ...
        <div class="lv2">
            <ul>
                <li class="sublist"></li>
                <li><a class="lv-back" href="#">&larr;Back</a></li>
            </ul>
        </div>
    </div>
    <div id="nav2">
        <!-- <ul class="nav-nav2">
					<li class="nav-type-page nav-item-0 nav-item-page-7"><a href="about"><span>About</span></a></li>
					<li class="nav-type-page nav-item-1 nav-item-page-8"><a href="contact"><span>Contact</span></a></li></ul> -->
    </div>
    <div id="nav3">
        <ul>
                                                        </ul>
        ...
        <script type="text/javascript">
			simpleCart({
				...
				checkout: {
					...
					extra_data: {
						_token: 'cGyIA1mMsmpWhpjr4JB18m7v48FnBGsUZYeYcB7v'
					}
				}
			});
			simpleCart.currency({
...
function crossfadeSlides() {
    var curr_week_starting_num = 303;
...
function pad (str, max) {
	...
	<script type="text/javascript">window.NREUM||(NREUM={});NREUM.info={"beacon":"bam.nr-data.net","licenseKey":"9fb7cc4286","applicationID":"12625886","transactionName":"NlRUbUBUWBdSVkZcDg8ed1pGXFkKHA==","queueTime":0,"applicationTime":145,"atts":"GhNXGwhOSxk=","errorBeacon":"bam.nr-data.net","agent":""}</script></body>
</html>
